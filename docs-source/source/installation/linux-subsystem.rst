...
-  do not install cloudmesh-gui on Linux subsystem as GUIs are not
   sported
...
now when you start a new ubuntu shell, you are all set and can work on
the install

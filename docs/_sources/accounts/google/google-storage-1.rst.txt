...
Google cloud platform provides varity of storage products which are
simple, reliable, and secure solutions for your media, analytics, and
application data.
...
documentation <https://cloud.google.com/storage/docs/>`__ for more
details on google cloud storage documentation. Cloudmesh currently
supports `object/blob
storage <https://cloud.google.com/storage/docs/how-to>`__ in beta
version. Users can follow instruction to configure google could platform

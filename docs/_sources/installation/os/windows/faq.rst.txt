...
Showcase the complete install of CMS in a video assuming you have done
the prerequisites as discussed later
...
-  Please note that this video discusses cloudmesh-windows starting at around 23 minutes. However, since then it was generalized and allows to be run on other OSes. To reflect this change it was renamed from
...
You must have cl installed. For detailed instruction on how to do this
see
...
Please make sure to switch off all Mongo Services and uninstall all
...
5. Enable Hyper-v Hypervisor by using the following command in PowerShell.
...
7. After reboot, run command to check the multipass installation.
...
If you have a space in your username, simply create a new Windows user

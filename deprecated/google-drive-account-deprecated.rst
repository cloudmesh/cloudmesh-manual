...
-  [ ] TODO: Google account. A program that takes the json files and
   integrates them into cloudmesh.yaml
...
-  [ ] TODO: The Authentication.py program was removed, so this can not
   work.
